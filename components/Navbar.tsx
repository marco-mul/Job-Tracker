...
// originally set up to be a server-side component:
// Navbar() was async because it was not client-side
// needed to "await" getSession (/lib/auth/auth.ts) because it is an async function
